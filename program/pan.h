...
#define PanSource	"vitalflow.pml"
...
#define _nstates3	11	/* safety_check */
#define minseq3	46
#define maxseq3	55
#define _endstate3	10

#define _nstates2	20	/* Pump */
#define minseq2	27
#define maxseq2	45
#define _endstate2	19

#define _nstates1	14	/* Controller */
#define minseq1	14
#define maxseq1	26
#define _endstate1	13

#define _nstates0	15	/* Sensor */
#define minseq0	0
#define maxseq0	13
...
typedef struct P3 { /* safety_check */
...
#define PPump	((P2 *)_this)
typedef struct P2 { /* Pump */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 4; /* proctype */
	unsigned _p   : 6; /* state    */
#ifdef HAS_PRIORITY
...
#define Air1	(sizeof(P1) - Offsetof(P1, current_level) - 1*sizeof(int))

#define PSensor	((P0 *)_this)
...
typedef struct State {
	...
	#endif
#endif
	unsigned pump_active : 1;
	uchar sensor_data;
	uchar pump_cmd;
	int glucose_level;
	int insulin_reservoir;
#ifdef TRIX
...
#define HAS_TRACK	0
/* hidden variable: */	uchar alarm_triggered;
